...
volatile uint8_t transmit_time;
extern volatile send_prev_spi_time;
extern volatile uint32_t prev_time_data;
/***********************************************************************************************************************
...
void r_intc0_interrupt(void)
{
	...
	asm("nop");
			transmit_time=(uint8_t)(time_data-send_prev_spi_time);
